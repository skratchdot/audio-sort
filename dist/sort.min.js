 ...
 * Licensed under the MIT license.
 */
function(a){"use strict";var b,c={};b=function(a,b,c,d){return a[d%b]+Math.floor(d/b)*c},c.getMidiNumber=function(a){var c,d,e,f,g,h,i;return c=sc.ScaleInfo.at(A.Sort.getSelected("scale")),d=c.pitchesPerOctave(),e=c.degrees(),f=e.length,g=Math.floor(A.Sort.getSelected("dataSize")/2),h=b(e,f,d,a),i=b(e,f,d,g),h+A.Sort.getSelected("centerNote")-i},a.A.Helper=c}(this),/*!
 * Project: Audio Sort
